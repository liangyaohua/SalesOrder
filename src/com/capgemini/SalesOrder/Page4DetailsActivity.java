 ...
 * Details screen.
 */
public class Page4DetailsActivity extends ListActivity implements IZGWSAMPLE_SRVRequestHandlerListener 
{
	...
	private Page4DetailsAdapter adapter; 
	...
	protected void updateResultsInUi()
	{
		...
		adapter = new Page4DetailsAdapter(this, entry);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
	{
		...
		Page4DetailsAdapter.SapSemantics sapSemantics = adapter.getSapSemantics(position);
