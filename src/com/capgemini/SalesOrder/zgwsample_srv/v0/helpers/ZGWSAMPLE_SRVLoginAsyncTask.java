 ...
 */
public class ZGWSAMPLE_SRVLoginAsyncTask extends AsyncTask<Void, Void, Boolean> 
{
	...
	private static final String TAG = "ZGWSAMPLE_SRVLoginAsyncTask";
	 ...
	 */
	public ZGWSAMPLE_SRVLoginAsyncTask(ILoginAsyncTask activity, Context context, String userName, String password, String vaultPassword, String vaultSalt) 
	{
	...
	protected Boolean doInBackground(Void... arg0) 
	{
		...
		try
        {
			result = ZGWSAMPLE_SRVRequestHandler.getInstance(context).executeLoginUsernamePassword(userName, password, vaultPassword, vaultSalt);
        } 
